...
{  
    ...
    {  
        Schema::create('elb_accounts', function (Blueprint $table) {  
            ...
            $table->timestamp('email_verified_at')->nullable(); // Enable email verification column
    ...
    {  
        Schema::dropIfExists('elb_accounts');  
    }  
};